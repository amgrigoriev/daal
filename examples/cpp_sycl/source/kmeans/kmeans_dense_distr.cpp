...
//                NumericTablePtr partialCentroids = localAlgorithm.getPartialResult()->get(kmeans::partialSums);
//                NumericTablePtr partialCounters = localAlgorithm.getPartialResult()->get(kmeans::nObservations);
//                NumericTablePtr partialObjFunc = localAlgorithm.getPartialResult()->get(kmeans::partialGoalFunction);
//                printNumericTable(partialCentroids, "First 10 dimensions of partial sums:", 20, 10);
//                printNumericTable(partialCounters, "Partial counters:", 20, 1);
//                printNumericTable(partialObjFunc, "Partial objFunction", 20, 1);
